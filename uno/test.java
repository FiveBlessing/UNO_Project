        ...
        while (true){
            switch (sum[i].name){
                ...
                case ("Jack"):{
                    ...
                    temp1=o1.outcard(n1.card,temp1,time1,time2);
                  //  temp1=new Card("Yellow",-1,"skip");
                    ...
                    if (temp1==null){
                        ...
                        time2=0;
                        temp1=temp2;
                        if (!temp1.function.equals("+2")||!temp1.function.equals("+4")){
                        o1.add_two(n1.card);
                        }
                        ...
                        if (temp1.number!=-1){
                            System.out.println("我上家出牌的数字为"+temp1.number);
                        }
                        if (temp1.color.equals("All")){
                            System.out.println("上家指定的颜色为"+colortemp);
                            temp1=new Card(colortemp,-1,"null");}
                            else {
                        ...
                        //问题：假如有功能是+4，此时的temp1会将+4替换为null???????????????????????????????????
                ...
                case ("Mary"):{
                    ...
                    if (temp1.function.equals("+2")){
                        if (o2.findfunction(n2.card,"+2")){
                            System.out.println("我可是有+2的人");
                            }
                        else
                            { int t =time1;
                                for (int ii =0;ii<time1;ii++){
                        o2.add_two(r2);
                        }
                                time1=0;
                                System.out.println("被+2了"+t+"次");
                        System.out.println("+2以后的手牌为：");
                        System.out.println(o2.pritn(r2));}

                        //需不需要在+2以后再出牌？在这里需不需要break；？
                    }
                    if (temp1.function.equals("+4")){
                        if(o2.findfunction(n2.card,"+4")){
                            System.out.println("我可是有+4的人");
//                          //  temp1=o2.findfunctioncard(n2.card,"+4");
...
//                            temp1=new Card(sentence,-1,"null");
                            ...
                            int t=time2;
                            for (int p = 0;p<time2;p++){
                                o2.add_four(r2);
                                }
                            time2=0;
                            System.out.println("被+4了"+t+"次");
                        System.out.println();
                        break;
                        }
                    }
                ...
                case ("David"):{
                    ...
                    Card temp2 = temp1;
                    temp1=o3.outcard(n3.card,temp1,time1,time2);
                   // if (temp2.function.equals("+4"))
                    System.out.println("我出的牌是"+temp1);
                    if (temp1!=null){
                    if (temp1.function.equals("+2")){
                        time1++;
