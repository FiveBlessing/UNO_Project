...
//转向
 ...
 //整理
    ...
    //出牌
    public Card outcard(Card[] o,Card a,int times1,int times2){//o是现在玩家的手牌，a是上家出的牌
        Card result=null;
        if (a==null){
            Random random=new Random();
...
//                        System.out.println("但是因为我出不去了，我的上家出牌为：");
                ...
                if (a.function.equals("+2")) {
                    if (findfunction(o, "+2")) {
                        ...
                        for (int i = 0; i < times1; i++) {
                            System.out.println("我被+2了"+times1+"次");
                            add_two(o);
                        }
                        System.out.println("我被+2了");
                        System.out.println();
                        System.out.println("我的上家出牌的颜色为："+a.color);
                ...
                if (a.function.equals("+4")) {
                    ...
                    if (findfunction(o, "+4")) {
                        ...
                        System.out.println("我被+4了"+times2+"次");
...
public String choicecolor(){
    ...
    public static void main(String[] args) {
        ...
        c.card();
        c.washcard();
        Operater a =new Operater(c.queue);
        Operater q =new Operater(c.queue);
        Card[] b=new Card[109];
        Card[] n=new Card[109];
        int time1=0;
        int time2=0;
...
//            c.washcard();
        ...
        Card temp=new Card("All",-1,"+4");
        System.out.println(a.outcard(b,temp,time1,time2));
        System.out.println();
